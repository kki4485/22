...
#print("여기는 태초마을! 함께 여정을 떠날 첫4번째 포켓몬을 선택하자")
...
#for num in range(3):
#    print(f"피카츄 {num+1}마리")

#pokemons=['파이리','피카츄','꼬북이']
#for num in range(3):
#    pokemons[num]="이브이"
#print(pokemons)
#print(num)
...
#       break
#    else:
#        print(f"'피카츄'가 시도할 공격을 선택하세요.")
#        num1=int(input("1.몸통바기기 2.아이언테일 3.백만볼트 : "))
#        num2=randint(1, 3)
 #       print(f"피카츄가 공격했다! 로켓단은 -{num1}의 데미지를 받았다.")
#        ro_hp-=num1
